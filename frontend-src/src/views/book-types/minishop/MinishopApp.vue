  ...
  <div class="d-flex flex-1 overflow-hidden mobile:flex-col">
    <aside class="d-flex flex-col overflow-hidden border-right max-w-35% mobile:max-w-full flex-grow mobile:w-full">
      <header class="d-flex h-16 gap-2 align-items-center justify-content-between px-4 py-3 border-bottom">
        <div>
          <button class="btn btn-primary-subtle"  @click="openCreateProductDialog"> Create product </button>
        </div>
        <div class="flex-grow">
          <select id="minishop-product-category-filter"
    ...
    <aside class="d-flex flex-col w-full h-full flex-1">
      ...
      <section class="px-4 mb-3 min-h-100">
        Your cart is empty
      </section>
      <section class="px-4 mb-3">
        <p class="text-xl mr-4">Total: 0</p> <button class="btn btn-green btn-lg">Go to Payment</button>
      </section>
    </aside>
